...
public class DeregisterRequest implements Event{
	 ...
	 * @param portNum
	 */
	public DeregisterRequest(String IPAddress, int portNum)
	{
	 ...
	 * this eventFactory and fill the fields in this class
	 * with it.
	 * @param din
	 * @throws IOException
	 */
	public DeregisterRequest(DataInputStream din) throws IOException
	{
		// read IPAddress
